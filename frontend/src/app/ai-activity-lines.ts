 ...
 * `subject_label` — which today is the document reading and the website read
 * and nothing else. A total map here would demand copy for sentences no server
 * can produce, which is the boilerplate the notDisplayed branch exists to avoid.
 *
