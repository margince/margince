...
export const BoardInSurface: StoryObj = {
  render: () => (
    ...
    >
      <PipelineBoard columns={boardColumns} cardHref={(d) => `#/deals/${d.id}`} />
    </ListSurface>
  ),
};
...
export const BoardWithAbsentMoney: StoryObj = {
  render: () => <PipelineBoard columns={absentMoneyColumns} cardHref={(d) => `#/deals/${d.id}`} />,
};
...
export const BoardWithWithheldCompany: StoryObj = {
  render: () => <PipelineBoard columns={withheldCompanyColumns} cardHref={(d) => `#/deals/${d.id}`} />,
};
