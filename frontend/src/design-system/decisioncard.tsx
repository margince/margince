...
export function DecisionCard({
  ...
  return (
    <article
      ...
      // already declared once, with the rest of the panel-ai family in
      // panel.css, and it is the same claim this card makes. Re-spelling it
      // here would be a second copy of the one signal that separates a
      // proposal from a persisted fact.
