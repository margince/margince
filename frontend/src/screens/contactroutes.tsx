...
type RouteEvidence = components["schemas"]["ContactGraphRouteEvidence"];
...
export function RoutesPanel({
  ...
  return (
    <Panel
      ...
      title={
        skipLead
          ? t("contact.intro.otherRoutesTitle")
          : t("contact.intro.routesTitle")
      }
    >
      ...
      <PanelBody>
        <p className="t-sub">
          {skipLead
            ? t("contact.intro.otherRoutesSub")
            : t("contact.intro.routesSub")}
        </p>
      </PanelBody>
    ...
    >
      ...
      <div className="pn-route-who">
        <p className="pn-route">
          ...
          {lead ? <Badge tone="accent">{t("contact.intro.best")}</Badge> : null}
      ...
      {/* A route that cannot be asked for offers no button. Rendering one that
          ...
          introducer is the contact making it. */}
 ...
 *
 * The reader's own route is written in the second contact. Naming a colleague
...
function routeSentence(
  ...
  if (through) {
    return mine
      ? t("contact.graph.routeViaYou", { through })
      : t("contact.graph.routeVia", { name: route.via_display_name, through });
  }
  return mine
    ? t("contact.graph.routeDirectYou")
    : t("contact.graph.routeDirect", { name: route.via_display_name });
}
...
export function evidenceSentence(
  ...
  const base = ev.two_way
    ? "contact.intro.evidenceTwoWay"
    : "contact.intro.evidenceOneSided";
...
function lastContactPhrase(
  ...
  switch (last.kind) {
    case "never":
      return t("contact.intro.whenNever");
    case "today":
      return t("contact.intro.whenToday");
    case "yesterday":
      return t("contact.intro.whenYesterday");
    case "days":
      return t("contact.intro.whenDays", {
...
export function availabilityLabel(
  ...
  switch (availability) {
    case "already_requested":
      return t("contact.intro.alreadyRequested");
    case "declined":
      return t("contact.intro.declined");
    case "unavailable":
      return t("contact.intro.unavailable");
    default:
      return null;
  }
}
