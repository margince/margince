...
function view(extra: Partial<Contact360> = {}): Contact360 {
  return {
    as_of: AS_OF,
...
function show(page: Contact360) {
  render(
    <LocaleProvider initial="en">
      <ContactReadings view={page} />
    </LocaleProvider>,
  );
  return screen.getByTestId("contact-readings");
}
...
describe("what we owe them", () => {
  ...
  // about the same contact, on the same screen.
