...
const meetingPrepMoment: components["schemas"]["ContactMoment"] = {
...
const goneQuietMoment: components["schemas"]["ContactMoment"] = {
...
const reEngagedMoment: components["schemas"]["ContactMoment"] = {
...
const jobChangeMoment: components["schemas"]["ContactMoment"] = {
...
const overduePromiseMoment: components["schemas"]["ContactMoment"] = {
...
const publicSignalMoment: components["schemas"]["ContactMoment"] = {
...
const missingNextStepMoment: components["schemas"]["ContactMoment"] = {
...
// two transports this contact does NOT have and omitting the two they do.
...
// thread" under the brief, on a contact with no address at all.
...
// --- Page: the whole ContactPageV2 behind its three reads --------------------
...
// lead verb pressable.
const guardAllowsMail: components["schemas"]["ContactConsentGuardEntry"][] = [
  {
...
const guardRefusesMail: components["schemas"]["ContactConsentGuardEntry"][] = [
  {
...
const mailAndChat: View = {
  ...
  contact: {
    ...populated.contact,
    reachability: chatConversation.contact.reachability,
  },
  activities: {
    data: [
...
export const Rail: Story = {
  render: () => {
    installFetchStub({
      "GET /me": () =>
        jsonResponse(meFixture({ allow: { contact: ["update"] } })),
    });
    return (
      <StoryProviders>
...
// three of derivedSignals' four warnings at once (contactrail.tsx) plus the
...
// --- Overview panels: the four cards plus ContactMemory, stacked -------------
      ...
      <StoryProviders>
        <div className="record-stack" style={{ maxWidth: 720 }}>
          <ContactBriefCard
            ...
            view={populated}
          />
          <ContactCommercialCard view={populated} />
          <ContactCommitmentsCard view={populated} firstName="Dana" />
          <ContactMattersCard view={populated} firstName="Dana" />
          <ContactMemory view={populated} />
        </div>
      </StoryProviders>
    );
  },
    ...
    return (
      <StoryProviders>
        <div className="record-stack" style={{ maxWidth: 720 }}>
          ...
          />
          <ContactMemory view={chatConversation} />
        </div>
      </StoryProviders>
    );
  },
...
// the room: the populated end of ContactCommercialCard that `populated`
...
const dealWithCommittee: View = {
  ...
  commercial: {
    ...
    committee: [
      { contact_id: "p-2", full_name: "Mika Voss", role: "economic_buyer" },
      { contact_id: "p-3", full_name: "Jonas Reiter", role: "influencer" },
    ],
  },
};

// One of every loop kind ContactCommitmentsCard renders, plus a `done` row:
...
// Every channel ContactMemory labels (meeting, call, note, beside the email
...
export const OverviewGaps: Story = {
  render: () => {
    ...
    return (
      <StoryProviders>
        <div className="record-stack" style={{ maxWidth: 720 }}>
          <ContactBriefCard brief={undefined} loading view={populated} />
          <ContactBriefCard
            brief={undefined}
            loading={false}
            view={populated}
          />
          <ContactCommercialCard view={withheld} />
          <ContactCommercialCard view={dealWithCommittee} />
          <ContactCommitmentsCard view={richLoops} firstName="Dana" />
          <ContactMemory view={richMemory} />
          <ContactMemory view={foldedActivities} onOpenEmail={() => {}} />
          <ContactMemory view={emptyMemory} />
        </div>
      </StoryProviders>
    );
  },
...
// (contactprovider.tsx): `providerNotConnected` above leaves every array
...
const providerRunning: components["schemas"]["ContactProviderProfile"] = {
  state: "in_progress",
  provider: "surfe",
  retrieved_at: null,
...
export const ResearchDrawerProviderRunning: Story = {
  render: () => {
    installFetchStub({
      ...
      "GET /contacts/p-1/enrichment-runs/run-2": () =>
...
const providerError: components["schemas"]["ContactProviderProfile"] = {
...
export const MeetingBrief: Story = {
  render: () => {
    ...
    return (
      <StoryProviders>
        <ContactMeetingBrief activityId="a-2" open onClose={() => {}} />
      </StoryProviders>
    );
  },
};
...
export const TabTimeline: Story = {
  render: () => {
    ...
    return (
      <StoryProviders>
        <ContactTimelineTab contactId="p-1" view={populated} />
      </StoryProviders>
    );
  },
};
...
export const TabTimelineWithheld: Story = {
  render: () => {
    ...
    return (
      <StoryProviders>
        <ContactTimelineTab contactId="p-1" view={withheld} />
      </StoryProviders>
    );
  },
};
...
export const TabMeetings: Story = {
  render: () => {
    ...
    return (
      <StoryProviders>
        <ContactMeetingsTab view={populated} />
      </StoryProviders>
    );
  },
};
...
export const TabMeetingsWithheld: Story = {
  render: () => {
    ...
    return (
      <StoryProviders>
        <ContactMeetingsTab view={withheld} />
      </StoryProviders>
    );
  },
};
