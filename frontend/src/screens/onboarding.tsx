...
// from the records it claims to describe. The app shell's gate, this journey
...
// gate holds every admin on the company form until then, so nobody can have
// been invited into an undescribed installation. `pending` is a read in flight:
// a seat that may not ask leaves it idle, and an idle read never answers.
