...
const CONTACT_ID = "3f7c1a90-0000-4000-8000-00000000c001";
...
function brief(over: Partial<ContactBrief>): ContactBrief {
  return {
...
function card(value: ContactBrief | undefined) {
  return () => {
    ...
    return (
      <StoryProviders>
        <div className="record-stack" style={{ maxWidth: 720 }}>
          <ContactBriefCard brief={value} loading={false} view={view} />
        </div>
      </StoryProviders>
    );
  };
...
export default meta;
type Story = StoryObj<typeof ContactBriefCard>;
