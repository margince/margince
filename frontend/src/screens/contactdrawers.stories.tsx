...
// contactresearch.stories.tsx; this is the WIDE drawer a rep works inside — the
...
type Story = StoryObj<typeof ContactResearchDrawer>;
...
export const Loading: Story = {
  render: () => {
    installFetchStub({
      ...
      "POST /contacts/p-1/research": () => new Promise<Response>(() => {}),
    });
    return drawer();
  },
};
