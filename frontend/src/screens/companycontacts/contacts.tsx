...
// The company's contacts, as a list a rep works from rather than a roster they
// read.
//
// The 360's contacts section answers "who works here" in twenty-five rows. This
...
export function CompanyContactsList({
  ...
  const state = useListQuery<CompanyContact>({
    ...
    // would make the page open on an alphabet and bury the contact who answered.
    initialSort: "",
    fetchPage,
  });
    ...
    <>
      ...
      <ListTable
        ...
        chips={[
          {
            key: "status",
            label: "co.contacts.filter.status",
            allLabel: "co.contacts.filter.statusAll",
            options: [
        ...
        columns={[
          ...
          {
            key: "engagement",
            header: t("co.contacts.engagement"),
            cell: (contact: CompanyContact) => (
          ...
          },
          {
            ...
            header: t("co.contacts.lastInteraction"),
        ...
        rowKey={(contact: CompanyContact) => contact.contact_id}
