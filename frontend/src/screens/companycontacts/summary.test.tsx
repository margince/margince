...
test("names the contact worth writing to", async () => {
  stub({
    best_way_in: {
      contact_id: "p-1",
...
// product's reading from a contact's assertion and disagree with the first.
...
// the machine's reading into a contact's answer.
...
test("offers no verbs on a seat a human typed", async () => {
  stub({
    deals: [{ deal_id: "d-1", name: "Retrofit 2026" }],
    selected_deal_id: "d-1",
    committee: {
