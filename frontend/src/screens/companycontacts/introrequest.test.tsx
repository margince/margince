...
// keeps claiming authorship of a sentence a contact wrote.
...
// component across prop changes. Drafting for one contact and then opening
// another showed the FIRST contact's message under the second one's name —
...
test("a fresh target starts with no draft", async () => {
  ...
  render(
    <IntroRequestModal
      companyId="o-1"
      target={{ ...TARGET, contactId: "p-2", contactName: "Jan Roth" }}
      onClose={() => {}}
    />,
  );
