...
// The contact rail, and specifically the states a permission produces — which
...
const guard: components["schemas"]["ContactConsentGuard"] = {
  contact_id: "p-1",
  entries: [
    {
...
// The narrowest read this page serves: the contact's own fields and nothing
