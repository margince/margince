...
export function EnrichedFields({
  contactId,
  view,
}: Readonly<{ contactId: string; view: Contact360 }>) {
  const t = useT();
  ...
  const mayCorrect = useCanWriteRecord("contact", view.contact);
  ...
  return (
    ...
    <Panel tone="ai" title={t("contact.enriched.title")}>
      <PanelBody>
