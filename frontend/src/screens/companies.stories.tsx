...
const company = {
  ...
  // date the contract requires of every company — omitted, the identity
...
const overviewRoutes = {
  "GET /companies/o-1": () => jsonResponse(company),
  "GET /companies/o-1/360": () => jsonResponse(company360),
  "GET /companies/o-1/hierarchy-rollup": () => jsonResponse(rollup),
  "GET /companies/o-1/brief": () =>
    jsonResponse({
      company_id: "o-1",
  ...
  "GET /records/company/o-1/context": () =>
    jsonResponse({
