...
export interface components {
    schemas: {
        ...
        /**
         * @description Payload for forecast.called — somebody accountable for a number said what they believe will close. The entity is the AUTHOR rather than a deal or a team, because a call is an assertion by a person and that person is who it is attributable to.
