...
export interface components {
    schemas: {
        ...
        /**
         * @description Payload for relationship_nudge.dismissed — a rep set a lapsed contact aside so their own Worklist stops raising them, or put them back (people's nudge dismissal). The entity is the CONTACT, which is what the judgement is about.
         ...
         */
        PublicEventRelationshipNudgeDismissed: {
            /** Format: uuid */
            person_id: string;
            /**
...
export const publicEventRelationshipNudgeDismissedActionValues: ReadonlyArray<FlattenedDeepRequired<components>["schemas"]["PublicEventRelationshipNudgeDismissed"]["action"]> = ["dismissed", "restored"];
