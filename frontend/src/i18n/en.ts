...
export const en = {
  ...
  "aiCert.result.reliable": "Reliable",
  "aiCert.result.mostly_reliable": "Mostly reliable",
  "aiCert.result.not_reliable": "Not reliable enough",
  "aiCert.result.partly_checked": "Partly checked",
  "aiCert.result.out_of_date": "Out of date",
  ...
  "aiCert.breakdownSub":
    "A job is reported as its weakest part. These are the parts behind each one.",
  ...
  // gates/aicertificationnames_test.go, which derives the required set from the
  // shipped-site census, so a new job without a name fails a test.
  ...
  "aiCert.job.deal_health": "Saying where a deal stands",
  "aiCert.job.document_extract": "Reading an attached document",
  "aiCert.job.draft_reply": "Drafting a reply",
  "aiCert.job.enrich": "Filling in details about a contact",
  "aiCert.job.growth_fit": "Judging how well a company fits what you sell",
  ...
  "aiCert.job.summarize": "Writing a summary",
  "aiCert.job.transcript_propose": "Pulling next steps out of a meeting",
  "aiCert.job.voice_build": "Learning how you write",
  "aiCert.job.weekly_review": "Writing your week in review",
  // The same, per invocation site, for the line naming which part of a job set
  // its result.
  "aiCert.site.agent_loop.loop": "working through a task",
  "aiCert.site.brief_ranking.rank": "ranking a briefing",
  "aiCert.site.capture_classify.classify": "sorting mail",
  "aiCert.site.capture_confidentiality_verdict.thread": "judging a thread",
  "aiCert.site.capture_counterparty_verdict.verdict": "judging a sender",
  "aiCert.site.cold_start.acts": "the setup conversation",
  "aiCert.site.cold_start.company_message": "asking about your company",
  "aiCert.site.cold_start.field_extract": "reading back what you told it",
  "aiCert.site.cold_start.sitereadmessage": "asking about your website",
  "aiCert.site.corpus_ask.corpus_ask": "answering from documents",
  "aiCert.site.deal_health.deal_status": "the deal card",
  "aiCert.site.document_extract.fields": "reading a document",
  "aiCert.site.draft_reply.account": "a company’s first approach",
  "aiCert.site.draft_reply.first": "a first message",
  "aiCert.site.draft_reply.intro": "an introduction",
  "aiCert.site.draft_reply.person": "the composer on a person",
  "aiCert.site.draft_reply.reply": "replying to an email",
  "aiCert.site.enrich.signature": "reading an email signature",
  "aiCert.site.growth_fit.growth_fit": "judging company fit",
  "aiCert.site.offer_draft.draft": "drafting an offer",
  "aiCert.site.propose_roles.committee": "naming the buying roles",
  "aiCert.site.rate_extract.fx": "reading exchange rates",
  "aiCert.site.rate_extract.pricing": "reading model prices",
  "aiCert.site.signal_extract.thread_events": "spotting events in a thread",
  "aiCert.site.site_extract.profile": "reading a company site",
  "aiCert.site.site_fact_extract.page_facts": "picking facts off a page",
  "aiCert.site.site_triage.triage": "classifying a website",
  "aiCert.site.summarize.meeting_plan": "summarising a meeting plan",
  "aiCert.site.summarize.org_ask": "answering about a company",
  "aiCert.site.summarize.org_brief": "briefing on a company",
  "aiCert.site.summarize.org_dossier": "a company dossier",
  "aiCert.site.transcript_propose.next_steps": "next steps from a transcript",
  "aiCert.site.voice_build.derive": "learning your voice",
  "aiCert.site.voice_build.eval_draft": "checking a draft in your voice",
  "aiCert.site.voice_build.eval_scores": "scoring a draft in your voice",
  "aiCert.site.weekly_review.narrative": "your week in review",
