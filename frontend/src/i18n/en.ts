...
export const en = {
  ...
  "worklist.verb.retryRefusedNotFailed": "Nothing to run again \u2014 this firing was stopped on purpose, not by an error.",
  "worklist.verb.retryRefusedRepeats": "This rule has not been cleared to run twice, so running it again could repeat what it already did.",
  "worklist.verb.retryRefusedEventGone": "The event behind this firing is gone, so it cannot be repeated. A scheduled rule checks again on its own.",
