...
export const en = {
  ...
  "tags.visibleWorkspaceWide": "Tag names are visible workspace-wide.",
  ...
  "tags.emptyBody": "Add durable context such as an event, a relationship, or a cohort.",
  "tags.pickerLabel": "Find a tag",
  "tags.alreadyAdded": "Already added",
  "tags.noMatch": "No tag by that name. An admin or ops seat can add one to the vocabulary.",
  "tags.applied": "Tag added",
  "tags.removed": "Tag removed",
  "tagResult.gone": "This tag no longer exists. It may have been merged into another.",
