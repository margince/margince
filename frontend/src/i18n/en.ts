...
export const en = {
  ...
  "company.filterStatusAll": "Any stage",
  ...
  "company.status.unknown": "Not assessed",
  "company.status.target": "Target",
  "company.status.prospect": "Prospect",
  "company.status.opportunity": "Opportunity",
  "company.status.customer": "Customer",
  "company.status.former_customer": "Former customer",
  "company.status.disqualified": "Disqualified",
  ...
  "co.strip.fin.neverInvoiced": "Never invoiced",
  ...
  "analytics.baseValueUnnamed": "Value",
  "analytics.forecastNoFigure": "Nothing measured",
  "analytics.myPipelineNoRow": "Nothing to read yet",
  ...
  "project.rollups.noneOpen": "No deal open",
  "project.rollups.noneWon": "None won yet",
