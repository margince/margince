...
export const vi = {
  ...
  "person.rail.editContactMethods": "Chỉnh sửa thông tin liên hệ",
  "person.rail.addEmail": "Thêm email",
  "person.rail.addPhone": "Thêm số điện thoại",
  "person.rail.contactValueEmail": "Địa chỉ email",
  "person.rail.contactValuePhone": "Số điện thoại",
  ...
  "person.contactType.mobile": "Di động",
  "person.contactType.other": "Khác",
