...
export const vi = {
  ...
  "approval.kind.relink_activity": "Gán lại một tin nhắn",
  "approval.kind.relink_thread": "Gán lại một cuộc trò chuyện",
  "approval.kind.relink_activities": "Gán lại nhiều tin nhắn",
