...
export const vi = {
  ...
  "brief.team.plan": "Xem kế hoạch hiện tại",
  "brief.approval.approve": "Phê duyệt",
  "brief.approval.email": "Phê duyệt email",
  "brief.coverage.source.approval": "Đề xuất",
  "brief.coverage.source.task": "Công việc",
  "brief.coverage.source.dsr": "Yêu cầu quyền riêng tư",
  ...
  "brief.weekly.learnings.caveat":
    "Các nhận xét mô tả mối liên hệ trong công việc được ghi nhận; không chứng minh nguyên nhân của kết quả.",
  ...
  "co.routeIn.bandBadge.strong": "Liên hệ đều đặn",
  "co.routeIn.bandBadge.some": "Có liên hệ ít nhiều",
  "co.routeIn.bandBadge.faint": "Gần như không liên hệ",
  "co.routeIn.bandBadge.unknown": "Có ghi nhận liên hệ, chưa rõ nhịp",
  ...
  "contactdealrooms.revokeTitle": "Thu hồi quyền vào {room}?",
  ...
  "billing.add": "Chỉ định đồng nghiệp",
  "billing.change": "Đổi",
  "billing.remove": "Gỡ bỏ",
  "billing.changeOne": "Đổi vai trò mà {who} đảm nhận",
  "billing.removeOne": "Gỡ {who} khỏi hoá đơn của tài khoản này",
  "billing.addTitle": "Ai xử lý các hoá đơn này",
  "billing.changeTitle": "Đổi phần họ xử lý",
  "billing.who": "Ai",
  "billing.findContact": "Tìm một liên hệ",
  "billing.role": "Phần họ xử lý",
  "billing.roleNote":
    "Mỗi vai trò một liên hệ chỉ giữ được một lần trên tài khoản này.",
  "billing.saveAdd": "Chỉ định",
  "billing.saveChange": "Lưu thay đổi",
  "billing.versionUnresolved":
    "Không đọc lại được liên hệ thanh toán này nên thay đổi chưa được gửi. Hãy tải lại và thử lại.",
  ...
  "co.brief.cite.contact.many": "{count} liên hệ",
  ...
  "approval.field.contact_name": "Liên hệ ở đây",
  ...
  "co.rail.contacts.title": "Liên hệ chủ chốt của họ",
  ...
  "co.contacts.strength": "Mối quan hệ",
  "co.contacts.neverInTouch": "Chưa có trao đổi",
  "co.contacts.theyWrote": "Họ đã viết",
  "co.contacts.weWrote": "Chúng ta đã viết",
  "co.contacts.filter.status": "Trạng thái liên hệ",
  "co.contacts.filter.statusAll": "Mọi trạng thái",
  "co.contacts.band.wayIn": "Cách tiếp cận tốt nhất",
  "co.contacts.band.noWayIn": "Chưa ai trả lời",
  "co.contacts.band.noWayInWhy": "Đã viết cho tất cả nhưng không ai trả lời",
  "co.contacts.band.committee": "Nhóm mua hàng",
  "co.contacts.band.missing": "Không có {role}",
  "co.contacts.band.committeeComplete": "Đã có champion và economic buyer",
  "co.contacts.band.committeeUnread": "Ẩn với bạn",
  ...
  "co.contacts.band.committeePartial": "Không thể đánh giá",
  "co.contacts.board.otherRoles": "Vai trò khác",
  "co.contacts.band.unavailable": "Không đọc được",
  "co.contacts.band.unavailableWhy":
    "Không tải được độ phủ; danh sách bên dưới không bị ảnh hưởng",
  "co.contacts.view": "Chế độ xem nhóm",
  "co.contacts.view.board": "Bảng",
  "co.contacts.view.map": "Bản đồ",
  "co.contacts.map.region": "Ai tiếp cận được ai",
  "co.contacts.map.bestRoute": "Đường tốt nhất",
  "co.contacts.map.alternatives": "Lựa chọn khác",
  "co.contacts.map.noRoute": "Chưa ghi nhận đường nào",
  "co.contacts.map.more": "Xem thêm {count}",
  "co.contacts.map.clear": "Bỏ chọn",
  "co.contacts.map.emptyTitle": "Chưa có đường nào",
  "co.contacts.map.emptyBody":
    "Gán vai trò mua hàng hoặc nhập các tương tác đã có.",
  "co.contacts.map.nothingSelected": "Chọn một liên hệ để xem đường tốt nhất.",
  "co.contacts.map.ourSide": "Phía chúng ta",
  "co.contacts.map.account": "Tài khoản",
  "co.contacts.map.missing": "Thiếu {role}",
  "co.contacts.map.awaiting": "đang chờ trả lời",
  "co.contacts.map.owed": "còn nợ hồi âm",
  "co.contacts.map.replied": "họ đã trả lời",
  "co.contacts.map.never": "chưa từng viết",
  "co.contacts.map.onDeal": "trong deal",
  "co.contacts.map.scope": "{count} trong nhóm mua hàng · chỉ deal đã chọn.",
  "co.contacts.map.routesWithheld": "Ai tiếp cận được họ bị ẩn với bạn",
  "co.contacts.map.assignHint": "Chưa ai dẫn dắt deal này",
  ...
  "lead.factorKind.fact": "Đã xác minh",
  "lead.factorKind.assumption": "Ước tính",
  "lead.factorKind.judgement": "Nhận định",
  ...
  "deal.strip.money.unpriced": "Chưa định giá",
  ...
  "deal.strip.contacts": "Các liên hệ",
  "deal.strip.contacts.count": "{engaged} trên {total} đang trao đổi",
  "deal.strip.contacts.champion": "đã có người ủng hộ",
  "deal.strip.contacts.noChampion": "chưa có người ủng hộ",
  "deal.strip.contacts.none": "Chưa có ai",
  "deal.strip.contacts.noneDetail": "Chưa ghi nhận ai trong deal này",
  ...
  "outcomeReview.empty": "Chưa có đánh giá nào",
  "outcomeReview.emptyDetail":
    "Ghi lại lý do thương vụ này kết thúc như vậy, khi lý do còn rõ ràng.",
  "outcomeReview.earlier": "Về một lần chốt trước đó",
  ...
  "deal.motionCrossSell": "Bán chéo",
  "deal.motionExpansion": "Mở rộng",
  "deal.motionExistingBusiness": "Khách hàng hiện có — chưa rõ",
  ...
  "assignments.who": "Ai",
  "assignments.findColleague": "Tìm một đồng nghiệp",
  "assignments.findTeam": "Tìm một nhóm",
  "assignments.role": "Vai trò",
  "assignments.rolePlaceholder": "Chọn vai trò",
  "assignments.saveAdd": "Giao trách nhiệm",
  ...
  "deals.filterMotionAll": "Mọi loại",
  "deals.filterPriority": "Độ ưu tiên",
  "deals.filterPriorityAll": "Mọi mức",
  "deals.filterAcquisition": "Nguồn",
  "deals.filterAcquisitionAll": "Mọi nguồn",
  ...
  "brief.weekly.learnings.insufficient":
    "Chưa đủ dữ kiện được ghi nhận để đưa ra nhận xét hữu ích.",
  ...
  "teamweekly.chooseTeam": "Chọn nhóm để xem công việc.",
  ...
  "plan.contract.capacityNote": "Năng lực còn lại",
  ...
  "plan.help.waiting": "Đã yêu cầu hỗ trợ · đang chờ phản hồi",
  ...
  "brief.weekly.outlook.none": "Chưa có bản dự báo được lưu cho tuần này.",
  ...
  "brief.digestClassify":
    "Đã phân loại: {commitments} cam kết, {meetings} cuộc họp, {noise} tin nhắn không cần hành động bán hàng.",
  ...
  "brief.deck.edited_other": "{count} đang sửa",
  "brief.deck.commitNothingToSend": "Hoàn tất",
  ...
  "ob.conv.triage.contactsCount": "tìm được {count}",
  ...
  "users.access.object.contact": "Liên hệ",
  ...
  "product.billingOneTime": "Một lần",
  "product.billingRecurring": "Định kỳ",
  "product.billingInterval": "Kỳ thanh toán",
  "product.billingNoInterval": "Chưa xác định",
  "product.billingMonthly": "Hằng tháng",
  "product.billingQuarterly": "Hằng quý",
  "product.billingHalfYearly": "Nửa năm một lần",
  "product.billingYearly": "Hằng năm",
  ...
  "contact.enriched.field.company_name": "Công ty",
  "contact.enriched.field.address": "Địa chỉ",
  "contact.enriched.field.website": "Trang web",
  "contact.enriched.readFrom": "Đọc từ {source} vào {when}",
  "contact.enriched.undo": "Hoàn tác",
  "contact.enriched.replaced": "Đã thay “{was}”, giá trị cũ hơn.",
  "contact.enriched.correctedByYou": "Bạn đã sửa",
  "contact.enriched.confirmed": "Đã xác nhận",
  "contact.enriched.correct": "Sửa",
  "contact.enriched.confirm": "Đúng rồi",
  "contact.enriched.save": "Lưu bản sửa",
  "contact.enriched.cancel": "Huỷ",
  "contact.graph.loading": "Đang đọc mạng lưới quanh liên hệ này…",
  "contact.graph.routeDirect": "{name} đã có trao đổi với họ.",
  "contact.graph.routeVia": "{name} có trao đổi với {through} ở cùng công ty.",
  "contact.graph.routeDirectYou": "Bạn đã có trao đổi với họ.",
  "contact.graph.routeViaYou": "Bạn có trao đổi với {through} ở cùng công ty.",
  "contact.graph.noRoute":
    "Chưa ai bên mình trao đổi với họ hay với ai ở công ty họ.",
  "contact.graph.noDirect": "Chưa ai bên mình trao đổi với họ.",
  "contact.graph.sideColumn": "Giới thiệu và khoảnh khắc",
  "contact.graph.recordWorksWith": "Ghi nhận: làm việc cùng {name}",
  ...
  "contact.intro.routesTitle": "Các lối vào",
  ...
  "contact.intro.verdictVia": "Hỏi {name} — tiếp cận được họ qua {through}.",
  "contact.intro.verdictDirectYou": "Bạn và họ đã trao đổi thư từ với nhau.",
  "contact.intro.verdictOneSidedYou": "Bạn đã gửi thư nhưng chưa được hồi âm.",
  "contact.intro.verdictViaYou": "Bạn tiếp cận được họ qua {through}.",
  "contact.intro.ownRouteNoAsk": "Không cần nhờ ai — bạn tự viết cho họ.",
  "contact.intro.evidenceEyebrow": "Bằng chứng phía sau",
  "contact.intro.evidenceExchanges": "Lượt trao đổi",
  "contact.intro.evidenceWindow": "trong 90 ngày",
  "contact.intro.evidenceFrom": "{count} từ {name}",
  "contact.intro.evidenceFromYou": "{count} từ bạn",
  "contact.intro.evidenceLastContact": "Liên hệ gần nhất",
  "contact.intro.lastToday": "Hôm nay",
  "contact.intro.lastYesterday": "Hôm qua",
  ...
  "contact.intro.stepNotSent": "chưa gửi",
  "contact.intro.stepAwaitingAnswer": "đang chờ đồng nghiệp",
  "contact.intro.stepIntroduction": "Giới thiệu",
  "contact.intro.stepNameDrop": "Đã nhắc tên",
  "contact.intro.stepWaiting": "đang chờ",
  "contact.intro.stepRecorded": "đã ghi nhận",
  "contact.intro.stepReply": "Phản hồi",
  "contact.intro.stepObserved": "nhận biết từ hoạt động đã ghi",
  "contact.intro.stepDone": "Xong",
  "contact.intro.stepCurrent": "Hiện tại",
  "contact.intro.stepPending": "Sau",
  "contact.intro.laneOurs": "Đội của ta",
  "contact.intro.laneTheirs": "Công ty của họ",
  "contact.intro.lanePeers": "Những người họ trao đổi",
  "contact.intro.laneTarget": "Người cần gặp",
  "contact.intro.useThisRoute": "Dùng hướng này",
  "contact.intro.mapRegion": "Ai tiếp cận được liên hệ này, và qua ai",
  "contact.intro.edgeDirect": "{name} trao đổi trực tiếp với họ",
  "contact.intro.edgeAccount": "làm việc với {name}",
  ...
  "contact.intro.evidenceOneSided_other":
    "{total} lượt tương tác trong 90 ngày, một chiều · {when}",
  "contact.intro.whenToday": "liên hệ gần nhất hôm nay",
  "contact.intro.whenYesterday": "liên hệ gần nhất hôm qua",
  "contact.intro.whenDays": "liên hệ gần nhất {days} ngày trước",
  "contact.intro.whenNever": "không có liên hệ gần đây",
  "contact.intro.askTitle": "Nhờ giới thiệu với {name}",
  "contact.intro.cancel": "Huỷ",
  "contact.intro.askAction": "Gửi lời nhờ giới thiệu",
  "contact.intro.askFailed": "Không ghi nhận được lời nhờ.",
  "contact.intro.reasonLabel": "Lý do bạn nhờ",
  ...
  "contact.intro.valueLabel": "Liên hệ đó được gì",
  "contact.intro.valueHint": "Lý do liên hệ đó muốn có cuộc trò chuyện này.",
  "contact.intro.noteLabel": "Ghi chú để đồng nghiệp chuyển tiếp",
  "contact.intro.noteHint":
    "Chỉ phần này đến tay liên hệ đó. Hãy viết sao cho có thể chuyển đi nguyên văn.",
  "contact.intro.nameDropAsk": "Xin phép được nhắc tên họ",
  ...
  "contact.intro.fallbackNameDrop": "Xin được nhắc tên họ thay thế",
  "contact.intro.fallbackNameDropHelp": "Bạn sẽ tự liên hệ và nhắc đến họ.",
  ...
  "contact.intro.decideTitle": "Lời nhờ giới thiệu với {name}",
  "contact.intro.decideLegend": "Câu trả lời của bạn",
  "contact.intro.decideAction": "Ghi nhận câu trả lời",
  "contact.intro.decideFailed": "Không ghi nhận được câu trả lời.",
  "contact.intro.decideReasonLabel": "Bạn muốn nói thêm gì",
  ...
  "contact.intro.answerAccept": "Tôi sẽ giới thiệu",
  "contact.intro.answerAcceptHelp": "Bạn tự thực hiện lời giới thiệu.",
  "contact.intro.answerNameDrop": "Bạn có thể nhắc tên tôi",
  ...
  "contact.intro.answerSuggest": "Hỏi người khác",
  "contact.intro.answerSuggestHelp": "Nêu tên đồng nghiệp phù hợp hơn để giúp.",
  "contact.intro.answerDecline": "Lần này thì không",
  ...
  "contact.intro.completeFailed": "Không thể ghi lại kết quả.",
  "contact.intro.withdrawAction": "Rút lại",
  "contact.intro.withdrawFailed": "Không thể rút lại lời nhờ.",
  "contact.intro.stateRequested": "Đang chờ đồng nghiệp",
  ...
  "contact.network.momentsTitle": "Điều gì đã thay đổi gần đây",
  "contact.network.momentsSub":
    "Những chuyển động trong quan hệ này, lấy từ chính các tin nhắn.",
  "contact.network.noMoments": "Gần đây quan hệ này không có chuyển động nào.",
  "contact.change.repliedAfterGap": "Họ hồi đáp sau {days} ngày im ắng.",
  "contact.change.wentQuiet": "Không có gì xảy ra suốt {days} ngày.",
  "contact.change.warmed": "Quan hệ đã chuyển từ {from} lên {to}.",
  "contact.change.cooled": "Quan hệ đã tụt từ {from} xuống {to}.",
  "contact.band.none": "chưa liên hệ",
  "contact.band.weak": "yếu",
  "contact.band.moderate": "vừa",
  "contact.band.strong": "mạnh",
  "contact.bandBadge.none": "Chưa liên hệ",
  ...
  "contact.rail.employer": "Nơi làm việc",
  "contact.rail.allCompaniesConnected":
    "Mọi kết quả đều đã liên kết với liên hệ này rồi.",
  "contact.rail.isCurrentEmployer": "Đây là nơi làm việc hiện tại của họ",
  "contact.rail.markEnded": "Đánh dấu đã kết thúc",
  "contact.rail.removeEmploymentTitle": "Gỡ liên kết với công ty này?",
  ...
  "contact.timeline.empty": "Chưa ghi nhận trao đổi nào với họ.",
  "contact.deals.empty": "Họ chưa được ghi nhận trên deal nào.",
  "contact.deals.untitled": "Deal chưa có tên",
  "contact.deals.noStage": "Chưa có giai đoạn",
  "contact.meetings.next": "Cuộc họp kế tiếp",
  ...
  "contact.meetings.participants": "Có mặt",
  "contact.documents.empty": "Chưa có tệp nào lưu cho liên hệ này.",
  "contact.research.empty": "Chưa nghiên cứu gì về họ.",
  "contact.research.fields": "Bằng chứng làm giàu dữ liệu",
  "contact.research.fieldsEmpty": "Chưa trường dữ liệu nào có bằng chứng.",
  "contact.research.capturedBy": "Ghi nhận bởi",
  "contact.action.email": "Email",
  "contact.action.write": "Soạn tin",
  "contact.action.messageOn": "Nhắn qua {transport}",
  "contact.action.noTransport":
    "Không có địa chỉ và không có cuộc trò chuyện nào để trả lời.",
  "contact.action.call": "Gọi",
  "contact.action.meetings": "Xem lịch hẹn",
  "contact.action.addTask": "Thêm việc",
  "contact.action.research": "Nghiên cứu",

  "contact.strip.lastInbound": "Nhận gần nhất",
  "contact.strip.lastOutbound": "Gửi gần nhất",
  "contact.strip.reciprocity": "Mức qua lại",
  "contact.strip.inOut": "{inbound} vào · {outbound} ra",
  "contact.strip.nextMeeting": "Cuộc họp tiếp theo",
  "contact.strip.never": "Chưa bao giờ",
  "contact.strip.today": "Hôm nay",
  "contact.strip.yesterday": "Hôm qua",
  "contact.strip.days": "{count} ngày trước",
  "contact.strip.noOpenDeal": "Không có deal đang mở",
  "contact.strip.noMeeting": "Không có",
  "contact.consent.allowedWord": "Được phép",
  "contact.consent.blockedWord": "Bị chặn",
  "contact.consent.unknownWord": "Chưa rõ",

  "contact.moment.rule.meeting_prep": "Sắp có cuộc họp",
  "contact.moment.rule.re_engaged": "Họ đã quay lại",
  ...
  "contact.commercial.title": "Deal đang mở & vai trò mua hàng",
  ...
  "contact.commercial.committee": "Hội đồng mua hàng",
  "contact.commercial.openDeal": "Mở deal",

  "contact.loops.title": "Cam kết & việc còn dở",
  "contact.loops.empty":
    "Trong các cuộc trò chuyện đã ghi nhận, không có cam kết hay câu hỏi nào.",
  "contact.loops.ours": "Bạn",
  "contact.loops.question": "Câu hỏi mở",
  "contact.loops.overdue_one": "quá hạn {count} ngày",
  "contact.loops.overdue_other": "quá hạn {count} ngày",
  "contact.loops.overdueUnderDay": "quá hạn chưa đến một ngày",
  ...
  "contact.memory.title": "Ký ức trò chuyện",
  "contact.memory.viewAll": "Xem tất cả hoạt động",
  "contact.memory.empty": "Chưa ghi nhận gì trên kênh này.",
  "contact.memory.all": "Tất cả",
  "contact.memory.email": "Email",
  "contact.memory.meetings": "Cuộc họp",
  "contact.memory.calls": "Cuộc gọi",
  "contact.memory.notes": "Ghi chú",
  "contact.memory.channelEmail": "Email",
  "contact.memory.channelMeeting": "Cuộc họp",
  "contact.memory.channelCall": "Cuộc gọi",
  "contact.memory.channelNote": "Ghi chú",
  "contact.memory.channelMessage": "Tin nhắn",
  "contact.memory.channelTask": "Công việc",
  "contact.memory.replied": "Đã hồi đáp",
  "contact.memory.unanswered": "Chưa hồi đáp",

  "contact.rail.reviewFirst": "Xem lại trước",
  "contact.rail.blocked": "Bị chặn",
  "contact.rail.pulseTitle": "Nhịp quan hệ",
  ...
  "contact.rail.colleagues_other": "{count} đồng nghiệp",
  "contact.rail.trend": "Xu hướng",
  "contact.rail.noInbound": "Không có thư đến",
  "contact.rail.cooling": "Đang nguội",
  "contact.rail.warming": "Đang ấm lên",
  "contact.rail.overall": "Tổng thể",
  "contact.rail.thin": "Mỏng",
  "contact.rail.atRisk": "Có rủi ro",
  "contact.rail.strong": "Vững",
  "contact.rail.whoKnows": "Ai quen {name}",
  "contact.rail.nobodyYet": "Ở đây chưa ai từng trao đổi với họ.",
  "contact.rail.exchanges": "{count} lượt trao đổi",
  "contact.rail.signals": "Tín hiệu & rủi ro",
  "contact.rail.noSignals": "Không có gì nổi bật ở mối quan hệ này.",
  "contact.rail.noReplyDays": "Không hồi đáp suốt {count} ngày",
  "contact.rail.repliedDaysAgo_one": "Đã hồi đáp {count} ngày trước",
  ...
  "contact.composer.intentAgenda": "đề xuất chương trình cho buổi hẹn sắp tới",
  "contact.composer.intentReply": "trả lời tin nhắn gần nhất của họ",
  "contact.composer.intentCommitment": "thực hiện điều chúng ta đã hứa",
  "contact.composer.intentFollowUp": "nhắc lại — đã lâu không có phản hồi",
  "contact.research.title": "Nghiên cứu sâu · {name}",
  "contact.research.publicOnly": "Chỉ nguồn công khai",
  "contact.research.running": "Đang đọc các nguồn công khai…",
  ...
  "contact.research.discard": "Hủy bỏ",
  "contact.research.save_one": "Xem lại & lưu {count} nhận định",
  "contact.research.save_other": "Xem lại & lưu {count} nhận định",
  "contact.research.mapField": "Trường hồ sơ",
  "contact.research.mapFieldPlaceholder": "Chọn một trường",
  "contact.research.mapValue": "Giá trị",
  "contact.research.mapQuote": "Trích dẫn nguồn",
  "contact.research.mapUrl": "Liên kết nguồn",
  "contact.research.mapUrlInvalid": "Nhập một liên kết http hoặc https.",
  "contact.research.mapIncomplete":
    "Thêm giá trị, trích dẫn và liên kết để lưu nhận định này.",
  "contact.research.saved_one": "Đã thêm {count} nhận định vào hồ sơ",
  "contact.research.saved_other": "Đã thêm {count} nhận định vào hồ sơ",
  "contact.research.field.title": "Chức danh",
  "contact.research.field.role": "Vai trò",
  "contact.research.field.company_name": "Công ty",
  "contact.research.field.phone": "Điện thoại",
  "contact.research.field.linkedin": "LinkedIn",
  "contact.research.field.address": "Địa chỉ",
  ...
  "contact.meeting.brief": "Xem tóm tắt",
  "contact.meeting.empty": "Chưa có gì được ghi lại cho cuộc họp này.",
  "contact.meeting.loading": "Đang tổng hợp bản tóm tắt…",
  "contact.meeting.assembledNow": "Vừa được tổng hợp từ dữ liệu mới nhất",
  "contact.meeting.header": "Tổng quan",
  "contact.meeting.what_changed": "Kể từ lần trao đổi gần nhất",
  "contact.meeting.goal": "Mục tiêu cuộc họp",
  "contact.meeting.attendees": "Người tham dự",
  "contact.meeting.commitments": "Cam kết còn mở",
  "contact.meeting.deal_state": "Tình trạng deal",
  "contact.meeting.risks": "Rủi ro và điểm cần lưu ý",
  "contact.meeting.talking_points": "Gợi ý nội dung trao đổi",
  "contact.meeting.company_context": "Lần gặp gần nhất",
  ...
  "contact.meeting.unknowns": "Những gì hồ sơ không cho biết",
  "contact.meeting.likelyAsks": "Những gì họ có thể hỏi",
  "contact.meeting.beReady": "Hãy sẵn sàng cho điều này",
  "contact.meeting.say": "Nói",
  "contact.meeting.show": "Cho xem",
  "contact.meeting.avoid": "Tránh",
  "contact.meeting.scenarios": "Nếu cuộc họp đi hướng khác",
  "contact.meeting.relevance.high": "Nhiều khả năng",
  "contact.meeting.relevance.medium": "Có thể",
  "contact.meeting.relevance.low": "Ít khả năng",
  "contact.meeting.coach.title": "Huấn luyện một điều duy nhất",
  "contact.meeting.coach.eyebrow": "Chế độ quản lý",
  "contact.meeting.coach.listenFor": "Lắng nghe",
  "contact.meeting.coach.watchFor": "Dấu hiệu cảnh báo",
  "contact.meeting.coach.interveneIf": "Chỉ can thiệp khi",
  "contact.meeting.coach.paths": "Các hướng cuộc họp có thể đi",
  "contact.meeting.background": "Bối cảnh và nguồn",
  "contact.meeting.omittedSource": "Không có trong bản tóm tắt này",
  "contact.meeting.preparedFor": "Chuẩn bị cho {name}",
  "contact.meeting.preparedForAt": "Chuẩn bị cho {name} · {company}",
  ...
  "worklist.board.title": "Công việc của nhóm cần xử lý",
  ...
  "worklist.readings.revenue.noFigure": "Chưa định giá",
  ...
  "contact.readings.lastMessage": "Tin nhắn gần nhất",
  "contact.readings.fromThem": "Từ họ",
  "contact.readings.fromUs": "Từ chúng ta",
  "contact.readings.quiet": "Đã im lặng",
  "contact.readings.neverSpoke": "Chưa từng trao đổi",
  "contact.readings.lastFromThem": "lần cuối từ họ: {when}",
  "contact.readings.neverReplied": "chưa có gì từ họ",
  "contact.readings.promises": "Lời hứa còn mở",
  "contact.readings.nothingOwed": "không nợ gì",
  "contact.readings.onTime": "chưa có lời hứa nào trễ",
  "contact.readings.deal": "Deal họ quyết định",
  ...
  "employment.importLoading": "Đang đọc lịch sử công việc đã mua…",
  "employment.apply": "Liên kết công ty đã nhập",
  "employment.status.current": "Hiện tại",
  "employment.status.former": "Trước đây",
  "employment.status.unknown": "Chưa rõ trạng thái",
  "employment.statusLabel": "Trạng thái công việc",
  "employment.review": "Xem lại vai trò trước khi liên kết.",
  "employment.matchNeeded": "Cần xác định công ty.",
  "employment.resolve": "Xác định công ty",
  "employment.dismiss": "Bỏ qua thông tin này",
  "employment.research": "Nghiên cứu",
  "employment.researchDeferred": "Đang chờ cài đặt nghiên cứu và ngân sách",
  "employment.website": "Website công ty đã xác nhận",
  "employment.websiteHint":
    "Chọn công ty hiện có hoặc xác nhận website chính thức để tạo công ty.",
  "employment.saveMatch": "Lưu liên kết công ty",
  "employment.researchNeedsWebsite": "Cần trang web",
  "employment.research.queued": "Đã xếp hàng",
  "employment.research.running": "Đang nghiên cứu",
  "employment.research.done": "Hoàn tất",
  ...
  "employment.researchQueued": "Trạng thái nghiên cứu có trên trang công ty.",
  "employment.edit": "Chỉnh sửa công việc",
