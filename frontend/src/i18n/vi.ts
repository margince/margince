...
export const vi = {
  ...
  "provider.profile.emptyBody":
    "Một lượt tra cứu sẽ hỏi nhà cung cấp dữ liệu đã kết nối về email công việc, số di động và vai trò hiện tại của liên hệ này. Việc đó tiêu tốn tín dụng, và những gì nhận được sẽ nằm cạnh hồ sơ chứ không ghi đè lên bất cứ điều gì đồng nghiệp đã nhập.",
