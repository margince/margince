...
export const vi = {
  ...
  "tags.visibleWorkspaceWide": "Tên tag hiển thị cho toàn bộ workspace.",
  ...
  "tags.emptyBody": "Thêm ngữ cảnh lâu dài như một sự kiện, một mối quan hệ hoặc một nhóm.",
  "tags.pickerLabel": "Tìm tag",
  "tags.alreadyAdded": "Đã thêm",
  "tags.noMatch": "Không có tag nào tên như vậy. Một chỗ ngồi admin hoặc ops có thể thêm vào từ vựng.",
  "tags.applied": "Đã thêm tag",
  "tags.removed": "Đã gỡ tag",
  "tagResult.gone": "Tag này không còn tồn tại. Có thể nó đã được gộp vào tag khác.",
