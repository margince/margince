...
export const vi = {
  ...
  "brief.brief.rank": "Hạng",
  "brief.brief.composite": "Điểm",
  "brief.brief.previouslyDismissed": "Đã đánh dấu {day} — bạn đã bỏ qua.",
  "brief.brief.returnedWith": "Quay lại do hoạt động ngày",
  "brief.brief.revenueBasis": "Doanh thu đo theo {amount}",
  "brief.brief.resurfaces": "Trở lại",
