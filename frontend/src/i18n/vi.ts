...
export const vi = {
  ...
  "company.filterStatusAll": "Mọi giai đoạn",
  ...
  "company.status": "Trạng thái tài khoản",
  "company.relationshipTypes": "Quan hệ với chúng ta",
  "company.sizeBand": "Quy mô công ty",
  "company.status.unknown": "Chưa đánh giá",
  "company.status.target": "Mục tiêu",
  "company.status.prospect": "Tiềm năng",
  "company.status.opportunity": "Cơ hội",
  "company.status.customer": "Khách hàng",
  "company.status.former_customer": "Khách hàng cũ",
  "company.status.disqualified": "Đã loại",
  ...
  "deal.timeline.empty": "Chưa ghi nhận gì trên deal này.",
