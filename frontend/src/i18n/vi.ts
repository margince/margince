...
export const vi = {
  ...
  "person.research.save_one": "Xem lại & lưu {count} nhận định",
  "person.research.save_other": "Xem lại & lưu {count} nhận định",
  "person.research.mapField": "Trường hồ sơ",
  "person.research.mapFieldPlaceholder": "Chọn một trường",
  "person.research.mapValue": "Giá trị",
  "person.research.mapQuote": "Trích dẫn nguồn",
  "person.research.mapUrl": "Liên kết nguồn",
  "person.research.mapUrlInvalid": "Nhập một liên kết http hoặc https.",
  "person.research.mapIncomplete":
    "Thêm giá trị, trích dẫn và liên kết để lưu nhận định này.",
  "person.research.saved_one": "Đã thêm {count} nhận định vào hồ sơ",
  "person.research.saved_other": "Đã thêm {count} nhận định vào hồ sơ",
  "person.research.field.title": "Chức danh",
  "person.research.field.role": "Vai trò",
  "person.research.field.org_name": "Công ty",
  "person.research.field.phone": "Điện thoại",
  "person.research.field.linkedin": "LinkedIn",
  "person.research.field.address": "Địa chỉ",
  "person.research.field.website": "Trang web",
