...
export const de = {
  ...
  "co.strip.next.none": "Keiner geplant",
  ...
  "co.contacts.band.untried":
    "{count} nie angeschrieben · {waiting} Antwort offen",
  ...
  "brief.weekly.scorecard.partialHistoryBasis":
    "Vor dem Verlauf · Zahlen oben sind Mindestwerte",
  ...
  "brief.readings.urgentBasis": "Jemand wartet · Zusage bricht",
  ...
  "analytics.forecastDeals": "{count} Deals",
  ...
  "forecast.currentCallDetail": "Call vom {date} · {gap} über den Belegen",
  ...
  "license.seats.over": "{count} über der Zusage",
  ...
  "forecast.pipelineBasis.manager_call": "laut Call",
  "forecast.pipelineBasis.historical_median": "laut 4-Perioden-Median",
  ...
  "contact.intro.stripNoRoutes": "Keiner",
  ...
  "worklist.readings.revenue.detail": "Heute treibende Deals",
  "worklist.readings.revenue.unpriced": "Treibende Deals · keiner bepreist",
