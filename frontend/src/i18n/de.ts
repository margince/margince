...
export const de = {
  ...
  "brief.weekly.scorecard.multiThreaded": "Mehr als eine Person",
  ...
  "brief.brief.rank": "Rang",
  "brief.brief.composite": "Bewertung",
  "brief.brief.previouslyDismissed":
    "Am {day} markiert — du hast es weggeklickt.",
  "brief.brief.returnedWith": "Zurück durch Aktivität am",
  "brief.brief.revenueBasis": "Umsatz gemessen an {amount}",
  "brief.brief.resurfaces": "Zurück",
