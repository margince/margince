...
export const de = {
  ...
  "co.facts.counts": "{deals} Deals \u00b7 {projects} Projekte",
  ...
  "approval.kind.relink_activity": "Nachricht neu zuordnen",
  "approval.kind.relink_thread": "Konversation neu zuordnen",
  "approval.kind.relink_activities": "Mehrere Nachrichten neu zuordnen",
