...
export const de = {
  ...
  "co.people.band.committeeUnread": "Für Sie nicht sichtbar",
  "co.people.band.committeeUnreadWhy":
    "Ihre Rolle darf die Deals dieses Kontos nicht lesen",
  "co.people.band.seatsHeld": "{count} im Team",
  "co.people.band.someHidden": "{count} weitere für Sie nicht sichtbar",
