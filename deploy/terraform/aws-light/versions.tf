terraform {
  # >= 1.9.0, not the full stack's 1.7.0 floor: variables.tf's
  # letsencrypt_email validation references var.enable_tls, and
  ...
  #   key          = "margince/aws-light/terraform.tfstate"
  #   region       = "eu-central-1"
  #   encrypt      = true
