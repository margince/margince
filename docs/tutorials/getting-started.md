...
One installation serves one workspace: on its first boot
...
the login response rather than relying on curl's jar; the server resolves its singleton workspace
