...
> company — the singleton workspace profile born in onboarding. This page is
...
Two writers reach it: the cold-start website read, and `uploadAnchorCompanyLogoIcon`.
