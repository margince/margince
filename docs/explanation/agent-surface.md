...
row scope, so a send or an archive it can spend is one that contact could spend unaided in the app, and
asking them to confirm it again made the agent surface weaker than the contact behind it rather than
