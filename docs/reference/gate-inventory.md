...
| `frontendapprovalkinds_test.go` | H3 | Every kind a proposal can be staged under must have words a reader recognises, or the queue prints the wire enum at them. |
