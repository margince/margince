...
`system 8,799 B (~2,199 tok)` — rules 8,517 B · boundary 282 B · after boundary 0 B · **cacheable 96%**
...
`system 12,295 B (~3,073 tok)` — rules 12,013 B · boundary 282 B · after boundary 0 B · **cacheable 97%**
