...
`system 9,470 B (~2,367 tok)` — rules 9,188 B · boundary 282 B · after boundary 0 B · **cacheable 97%**
...
`system 12,966 B (~3,241 tok)` — rules 12,684 B · boundary 282 B · after boundary 0 B · **cacheable 97%**
