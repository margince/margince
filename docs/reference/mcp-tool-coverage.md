...
| Prompt tokens spent on tools no case requires | 12501 |
| Use cases | 21 |
...
|---|---:|---|---|---|---|
| `run_report` | 1011 | `case7_ask_for_a_number` | `case20_put_it_in_the_board_pack`, `case21_what_are_we_closing`, `case22_can_i_trust_the_numbers` | `agent_loop` | — |
