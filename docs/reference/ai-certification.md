...
118 of the 138 grades below were measured on an older version of the product and
...
| [`gemini_cloud`](#gemini_cloud) | global cloud | 18 | 5 | 4 | 0 | 18 of 27 features ready (7 re-checks pending), 2 not served (local-only data) |
...
Your data goes to: global cloud. 18 of 27 features ready (7 re-checks pending), 2 not served (local-only data). Preset file: [`gemini_cloud.yaml`](../../config/presets/gemini_cloud.yaml).

| Feature | Can I use it? | In plain words |
|---|---|---|
| Agent reasoning loop <sub>`agent_loop`</sub> | ✅ Ready | Right every time (18 of 18) |
| Buying-role reading <sub>`propose_roles`</sub> | ⚠️ Usable with care | Right every time (15 of 15); answer quality below the bar in one test case |
...
| Morning brief ranking <sub>`brief_ranking`</sub> | ⚠️ Usable with care | Right in 8 of 9 tries; answer quality below the bar in one test case |
| Offer drafting <sub>`offer_draft`</sub> | ✅ Ready | Right in 31 of 33 tries |
| Onboarding read <sub>`cold_start`</sub> | ❌ Not reliable yet | Right in 30 of 33 tries; one test case wrong too often; answer quality below the bar in one test case |
...
| Thread confidentiality check <sub>`capture_confidentiality_verdict`</sub> | 🔒 Not served here | Not served on this preset — local-only data, and it has no local model for it |
| Unanswered-message triage <sub>`owed_verdict`</sub> | ⚠️ Usable with care | Right in 25 of 27 tries; answer quality below the bar in one test case |
...
| `brief_ranking` | `premium` | `gemini-3.5-flash` | ⚠️ Usable with care | current |
...
| `deal_health` | `cheap_cloud` | `gemini-3.1-flash-lite` | ⚠️ Usable with care | current |
...
| `growth_fit` | `cheap_cloud` | `gemini-3.1-flash-lite` | ✅ Ready | current |
| `offer_draft` | `cheap_cloud` | `gemini-3.1-flash-lite` | ✅ Ready | current |
| `owed_verdict` | `local_small` | `gemini-3.1-flash-lite` | ⚠️ Usable with care | current |
...
Counted per record — one (task, binding) pair — over the 136 stale record(s) this build can attribute. A record appears on more than one row when a change moved a case and the prompt built from it together.
...
| **the prompt this build sends** | 109 | The product changed. The band describes the NEW prompt, so a drop is the cost of that change and not the model. |
| how a run is graded | 136 | What the judge is asked, or the rule that turns its scores into a grade, changed. A band can shift with neither the test nor the product touched. |
...
| [`brief_ranking/rank`](#brief_rankingrank) | `gemini · gemini-3.5-flash · cloud_frontier` | `supported_degraded` | 0.89 | `current` | 1 | 7 |
| [`capture_classify/classify`](#capture_classifyclassify) | `gemini · gemini-3.1-flash-lite · cloud_frontier` | `certified` | 1.00 | `current` | 5 | 7 |
...
| [`cold_start/sitereadmessage`](#cold_startsitereadmessage) | `gemini · gemini-3.1-flash-lite · cloud_frontier` | `not_supported` | 0.50 | `current` | 2 | 6 |
| [`corpus_ask/corpus_ask`](#corpus_askcorpus_ask) | `gemini · gemini-3.5-flash · cloud_frontier` | `certified` | 1.00 | `current` | 5 | 7 |
| [`deal_health/deal_status`](#deal_healthdeal_status) | `gemini · gemini-3.1-flash-lite · cloud_frontier` | `supported_degraded` | 1.00 | `current` | 3 | 5 |
...
| [`growth_fit/growth_fit`](#growth_fitgrowth_fit) | `gemini · gemini-3.1-flash-lite · cloud_frontier` | `certified` | 1.00 | `current` | 2 | 5 |
| [`offer_draft/draft`](#offer_draftdraft) | `gemini · gemini-3.1-flash-lite · cloud_frontier` | `certified` | 0.94 | `current` | 5 | 6 |
| [`owed_verdict/owed`](#owed_verdictowed) | `gemini · gemini-3.1-flash-lite · cloud_frontier` | `supported_degraded` | 0.93 | `current` | 4 | 6 |
...
| [`rate_extract/fx`](#rate_extractfx) | `gemini · gemini-3.5-flash · cloud_frontier` | `supported_degraded` | 1.00 | `current` | 2 | 7 |
| [`rate_extract/pricing`](#rate_extractpricing) | `gemini · gemini-3.5-flash · cloud_frontier` | `supported_degraded` | 1.00 | `current` | 1 | 7 |
| [`request_settlement/request_settle`](#request_settlementrequest_settle) | `gemini · gemini-3.1-flash-lite · cloud_frontier` | `certified` | 1.00 | `current` | 4 | 6 |
...
| [`site_triage/triage`](#site_triagetriage) | `gemini · gemini-3.1-flash-lite · cloud_frontier` | `certified` | 1.00 | `current` | 5 | 6 |
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini` | `gemini-3.1-flash-lite` | `cloud_frontier` | 41 | 19 | 0 | 22 | 495 | 485 | 0.98 | 10243ms | 27 | 9 | 5 |
| `gemini` | `gemini-3.1-pro-preview` | `cloud_frontier` | 6 | 0 | 0 | 6 | 36 | 36 | 1.00 | 46554ms | 4 | 0 | 2 |
| `gemini` | `gemini-3.5-flash` | `cloud_frontier` | 13 | 6 | 0 | 7 | 108 | 107 | 0.99 | 11911ms | 6 | 4 | 3 |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 2/2 | `certified` | 12 | 12 | 1.00 | 1687ms | 2293ms | 12 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 3/3 | `certified` | 9 | 9 | 1.00 | 1384ms | 1849ms | 9 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.5-flash · cloud_frontier` | `current` | 1/1 | `supported_degraded` | 9 | 8 | 0.89 | 3836ms | 4368ms | 8 | 0 | 1 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 5/5 | `certified` | 18 | 18 | 1.00 | 1395ms | 10243ms | 18 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.5-flash · cloud_frontier` | `current` | 2/2 | `certified` | 12 | 12 | 1.00 | 1943ms | 3754ms | 12 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 5/5 | `certified` | 21 | 21 | 1.00 | 1330ms | 2257ms | 21 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 1/1 | `supported_degraded` | 3 | 3 | 1.00 | 1330ms | 2257ms | 3 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 2/2 | `not_supported` | 6 | 3 | 0.50 | 1330ms | 2257ms | 3 | 0 | 3 | 0 |
...
| `gemini · gemini-3.5-flash · cloud_frontier` | `current` | 5/5 | `certified` | 15 | 15 | 1.00 | 3688ms | 6462ms | 15 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 3/3 | `supported_degraded` | 27 | 27 | 1.00 | 2684ms | 5131ms | 27 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.5-flash · cloud_frontier` | `current` | 4/4 | `certified` | 12 | 12 | 1.00 | 5159ms | 9683ms | 12 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 1/1 | `certified` | 9 | 9 | 1.00 | 1660ms | 2234ms | 9 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 2/2 | `certified` | 12 | 12 | 1.00 | 4402ms | 6686ms | 12 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 5/5 | `certified` | 33 | 31 | 0.94 | 1233ms | 2278ms | 25 | 2 | 0 | 6 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 4/4 | `supported_degraded` | 27 | 25 | 0.93 | 1260ms | 1625ms | 25 | 2 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 3/3 | `supported_degraded` | 15 | 15 | 1.00 | 1461ms | 7178ms | 15 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.5-flash · cloud_frontier` | `current` | 2/2 | `supported_degraded` | 6 | 6 | 1.00 | 3387ms | 7994ms | 6 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.5-flash · cloud_frontier` | `current` | 1/1 | `supported_degraded` | 3 | 3 | 1.00 | 3387ms | 7994ms | 3 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 4/4 | `certified` | 12 | 12 | 1.00 | 1342ms | 6420ms | 12 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 4/4 | `certified` | 12 | 12 | 1.00 | 1262ms | 1772ms | 12 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 5/5 | `certified` | 15 | 15 | 1.00 | 1240ms | 4803ms | 15 | 0 | 0 | 0 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 9/9 | `certified` | 27 | 27 | 1.00 | 1332ms | 1754ms | 15 | 0 | 0 | 12 |
...
| Binding | State | Scenarios | Band | Runs | Passed | Reliability | Record p50 | Record p95 | `accepted` | `wrong_answer` | `invalid` | `abstained` |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini · gemini-3.1-flash-lite · cloud_frontier` | `current` | 3/3 | `certified` | 9 | 9 | 1.00 | 1007ms | 1606ms | 9 | 0 | 0 | 0 |
