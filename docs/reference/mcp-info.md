...
| Tools | 75 |
| Resources | 12 |
| Tool catalog | 214.1 KB |
| Resource catalog | 4.5 KB |
| Approx. wire tokens | 55950 |
...
| Descriptions (incl. governance clause) | 55.3 KB | 25% | Yes, every step |
| Input schemas | 44.3 KB | 20% | Yes, every step |
| _Names, annotations, punctuation_ | 15.8 KB | 7% | Partly |
| **Description + input schema** | **99.6 KB** | **46%** | **the recurring cost** |
