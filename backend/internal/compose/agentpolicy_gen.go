...
var agentPolicies = map[string]agentPolicy{
	...
	"DELETE /v1/projects/{id}/companies/{organization_id}":               {Op: "removeProjectCompany", Access: "tool", Tool: "update_record", RecordType: "project", Tier: "confirmation_required", Scope: "write"},
	...
	"PUT /v1/projects/{id}/companies":                                    {Op: "setProjectCompany", Access: "tool", Tool: "update_record", RecordType: "project", Tier: "confirmation_required", Scope: "write"},
