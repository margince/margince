...
var agentPolicies = map[string]agentPolicy{
	...
	"DELETE /v1/companies/{id}":                                             {Op: "archiveCompany", Access: "tool", Tool: "archive_record", RecordType: "company", Tier: "auto_execute", Scope: "write"},
	"DELETE /v1/companies/{id}/facts/{factKey}":                             {Op: "deleteCompanyFact", Access: "tool", Tool: "update_record", RecordType: "company", Tier: "auto_execute", Scope: "write"},
	"DELETE /v1/company/logo":                                               {Op: "deleteAnchorCompanyLogo", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"DELETE /v1/company/logo/icon":                                          {Op: "deleteAnchorCompanyLogoIcon", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"DELETE /v1/connectors/{provider}/backfill":                             {Op: "cancelConnectorBackfill", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"DELETE /v1/contacts/{id}":                                              {Op: "archiveContact", Access: "tool", Tool: "archive_record", RecordType: "contact", Tier: "auto_execute", Scope: "write"},
	"DELETE /v1/contacts/{id}/nudge-dismissal":                              {Op: "restoreRelationshipNudge", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"DELETE /v1/mail-drafts/{id}":                                           {Op: "discardMailDraft", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"DELETE /v1/projects/{id}/companies/{company_id}":                       {Op: "removeProjectCompany", Access: "tool", Tool: "update_record", RecordType: "project", Tier: "auto_execute", Scope: "write"},
	"DELETE /v1/projects/{id}/stakeholders/{contact_id}":                    {Op: "removeProjectStakeholder", Access: "tool", Tool: "update_record", RecordType: "project", Tier: "auto_execute", Scope: "write"},
	...
	"GET /v1/companies/{id}/scan":                                           {Op: "getCompanyScan", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"GET /v1/companies/{id}/site-reads/latest":                              {Op: "getLatestSiteRead", Access: "tool", Tool: "read_record", RecordType: "company", Tier: "auto_execute", Scope: "read"},
	"GET /v1/companies/{id}/site-reads/{readId}":                            {Op: "getSiteRead", Access: "tool", Tool: "read_record", RecordType: "company", Tier: "auto_execute", Scope: "read"},
	"GET /v1/companies/{id}/technical-enrich/latest":                        {Op: "getLatestTechnicalEnrich", Access: "tool", Tool: "read_record", RecordType: "company", Tier: "auto_execute", Scope: "read"},
	"GET /v1/companies/{id}/vat-check":                                      {Op: "getCompanyVatCheck", Access: "tool", Tool: "read_record", RecordType: "company", Tier: "auto_execute", Scope: "read"},
	"GET /v1/company":                                                       {Op: "getAnchorCompany", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"GET /v1/company/context":                                               {Op: "getAnchorCompanyContext", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"GET /v1/company/context/capabilities":                                  {Op: "getAnchorCompanyContextCapabilities", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"GET /v1/company/site-reads/{readId}":                                   {Op: "getAnchorCompanySiteRead", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"GET /v1/contacts/{id}/brief":                                           {Op: "getContactBrief", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"GET /v1/forecast/assurance/preview":                                    {Op: "previewForecastAssurance", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"GET /v1/forecast/shares":                                               {Op: "listForecastShares", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"GET /v1/retention/legal-holds":                                         {Op: "listLegalHolds", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"PATCH /v1/activity-review-templates/{id}":                              {Op: "updateActivityReviewTemplate", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"PATCH /v1/assignments/{id}":                                            {Op: "updateRecordAssignment", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"PATCH /v1/companies/{id}":                                              {Op: "updateCompany", Access: "tool", Tool: "update_record", RecordType: "company", Tier: "auto_execute", Scope: "write"},
	"PATCH /v1/companies/{id}/facts/{factKey}":                              {Op: "updateCompanyFact", Access: "tool", Tool: "update_record", RecordType: "company", Tier: "auto_execute", Scope: "write"},
	"PATCH /v1/companies/{id}/profile-fields/{field}":                       {Op: "updateCompanyProfileField", Access: "tool", Tool: "update_record", RecordType: "company", Tier: "auto_execute", Scope: "write"},
	"PATCH /v1/contacts/{id}":                                               {Op: "updateContact", Access: "tool", Tool: "update_record", RecordType: "contact", Tier: "auto_execute", Scope: "write"},
	...
	"PATCH /v1/public/meeting/{token}":                                      {Op: "changePublicMeetingInvitation", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"PATCH /v1/record-roles/{id}":                                           {Op: "updateRecordRole", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"PATCH /v1/scheduling/invitations/{id}":                                 {Op: "changeMeetingInvitation", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/acquisition-sources":                                          {Op: "createAcquisitionSource", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/communication-reviews/{id}/context":                           {Op: "recordCommunicationContext", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/companies/{id}/deep-read":                                     {Op: "deepReadCompany", Access: "tool", Tool: "enrich", RecordType: "company", Tier: "confirmation_required", Scope: "enrich"},
	"POST /v1/companies/{id}/dossier":                                       {Op: "refreshCompanyDossier", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/companies/{id}/draft-email":                                   {Op: "draftCompanyEmail", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/companies/{id}/enrich":                                        {Op: "scrapeCompany", Access: "tool", Tool: "enrich", RecordType: "company", Tier: "confirmation_required", Scope: "enrich"},
	"POST /v1/companies/{id}/facts":                                         {Op: "createCompanyFact", Access: "tool", Tool: "update_record", RecordType: "company", Tier: "auto_execute", Scope: "write"},
	"POST /v1/companies/{id}/facts/{factKey}/confirm":                       {Op: "confirmCompanyFact", Access: "tool", Tool: "update_record", RecordType: "company", Tier: "auto_execute", Scope: "write"},
	"POST /v1/companies/{id}/growth-fit":                                    {Op: "refreshCompanyGrowthFit", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/companies/{id}/intro-request-draft":                           {Op: "draftIntroRequest", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/companies/{id}/merge":                                         {Op: "mergeCompany", Access: "tool", Tool: "merge_records", RecordType: "company", Tier: "auto_execute", Scope: "write"},
	"POST /v1/companies/{id}/profile-fields/{field}/confirm":                {Op: "confirmCompanyProfileField", Access: "tool", Tool: "update_record", RecordType: "company", Tier: "auto_execute", Scope: "write"},
	"POST /v1/companies/{id}/reject":                                        {Op: "rejectCompany", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/companies/{id}/scan":                                          {Op: "ensureCompanyScan", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/companies/{id}/suggestions/dismiss":                           {Op: "dismissCompanySuggestion", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/companies/{id}/technical-enrich":                              {Op: "technicalEnrichCompany", Access: "tool", Tool: "enrich", RecordType: "company", Tier: "confirmation_required", Scope: "enrich"},
	"POST /v1/companies/{id}/vat-check":                                     {Op: "requestCompanyVatCheck", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/companies/{id}/view-ack":                                      {Op: "acknowledgeCompanyView", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/company/logo":                                                 {Op: "uploadAnchorCompanyLogo", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/company/logo/icon":                                            {Op: "uploadAnchorCompanyLogoIcon", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/company/site-reads":                                           {Op: "startAnchorCompanySiteRead", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/company/site-reads/{readId}/confirm":                          {Op: "confirmAnchorCompanySiteRead", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/company/site-reads/{readId}/messages":                         {Op: "messageAnchorCompanySiteRead", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/confirm-submissions/{id}/resolve":                             {Op: "resolveConfirmSubmission", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/contacts":                                                     {Op: "createContact", Access: "tool", Tool: "create_record", RecordType: "contact", Tier: "auto_execute", Scope: "write"},
	"POST /v1/contacts/quick-capture":                                       {Op: "quickCaptureContact", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/vcard-import":                                        {Op: "importVCards", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/brief":                                          {Op: "regenerateContactBrief", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/claims":                                         {Op: "recordConversationClaim", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/contacts/{id}/draft-email":                                    {Op: "draftContactEmail", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/employment-import":                              {Op: "applyContactEmploymentImport", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/enrichment-runs":                                {Op: "createContactEnrichmentRun", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/intro-note-draft":                               {Op: "draftIntroNote", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/intro-requests":                                 {Op: "createIntroRequest", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/merge":                                          {Op: "mergeContact", Access: "tool", Tool: "merge_records", RecordType: "contact", Tier: "auto_execute", Scope: "write"},
	"POST /v1/contacts/{id}/moment/dismiss":                                 {Op: "dismissContactMoment", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/profile-fields/{field}/restore":                 {Op: "restoreContactProfileField", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/publish":                                        {Op: "publishCapturedContact", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/research":                                       {Op: "runContactResearch", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/research/save":                                  {Op: "saveContactResearch", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/contacts/{id}/view-ack":                                       {Op: "acknowledgeContactView", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/privacy/notice-cases/{id}/assign":                             {Op: "assignNoticeCase", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/privacy/notice-cases/{id}/excuse":                             {Op: "excuseNoticeCase", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/projects/{id}/health-assessments":                             {Op: "createProjectHealthAssessment", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/public/proposal/{token}":                                      {Op: "acceptPublicMeetingProposal", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/retention/legal-holds/{entityType}/{recordId}/lift":           {Op: "liftLegalHold", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"POST /v1/retention/legal-holds/{entityType}/{recordId}/place":          {Op: "placeLegalHold", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/scheduling/invitations":                                       {Op: "createMeetingInvitation", Access: "tool", Tool: "invite_meeting", RecordType: "contact", Tier: "confirmation_required", Scope: "send"},
	"POST /v1/scheduling/proposals":                                         {Op: "createMeetingProposal", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"POST /v1/users/former":                                                 {Op: "createFormerMember", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"PUT /v1/companies/{id}/partner":                                        {Op: "upsertPartner", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	"PUT /v1/company":                                                       {Op: "putAnchorCompany", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"PUT /v1/scheduling/profile":                                            {Op: "putSchedulingProfile", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
