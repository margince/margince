...
var agentPolicies = map[string]agentPolicy{
	...
	"POST /v1/notices/read-all":                                             {Op: "markAllNoticesRead", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"PUT /v1/me/notification-preferences":                                   {Op: "saveNotificationPreference", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
