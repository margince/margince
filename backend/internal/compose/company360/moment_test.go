...
// accidental.
func stepsOf(rows ...crmcontracts.Company360NextStep) ([]crmcontracts.Company360NextStep, []time.Time) {
...
func tasksOf(rows ...crmcontracts.Company360NextStep) []crmcontracts.Company360NextStep {
	return rows
}

func task(subject string, dueInDays int) crmcontracts.Company360NextStep {
	return crmcontracts.Company360NextStep{
