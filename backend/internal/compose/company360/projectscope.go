...
func (o AssembleOptions) admit(ctx context.Context, tx pgx.Tx, companyID ids.CompanyID, out *crmcontracts.Company360) error {
	if o.ProjectID == nil {
		return nil
	}
	...
	scope, err := activities.ReadProjectScope(ctx, tx, *o.ProjectID, func(arg func(any) int) string {
		return activities.CompanyLinkedActivityExists(arg(companyID))
	})
	if err != nil {
		return err
	}
