...
func TestBootstrapSeedsFollowTheDeploymentConfiguration(t *testing.T) {
	...
	cfg := deployconfig.Config{
		Version: 1,
		Company: deployconfig.Workspace{Name: "Configured Company", BaseCurrency: "USD", Timezone: "Europe/Berlin"},
...
func TestBootBindsWithoutReadingASpentBootstrapSecret(t *testing.T) {
	...
	cfg := deployconfig.Config{
		Version: 1,
		Company: deployconfig.Workspace{Name: "Spent Secret Company", BaseCurrency: "EUR", Timezone: "Europe/Berlin"},
		BootstrapAdmin: &deployconfig.BootstrapAdmin{
...
func TestFirstBootStillFailsLoudlyOnAnUnreadableSecret(t *testing.T) {
	...
	cfg := deployconfig.Config{
		Version: 1,
		Company: deployconfig.Workspace{Name: "No Secret Company", BaseCurrency: "EUR", Timezone: "Europe/Berlin"},
		BootstrapAdmin: &deployconfig.BootstrapAdmin{
