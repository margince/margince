...
func TestOnlyAMomentsRowBackedEvidenceBecomesACitation(t *testing.T) {
	...
	view.Moment = &crmcontracts.ContactMoment{
		Rule: crmcontracts.ContactMomentRuleOverduePromise, Headline: "You owe them the list",
		Evidence: []crmcontracts.ContactMomentEvidence{
			{Type: crmcontracts.ContactMomentEvidenceTypeActivity, Id: &activity},
			{Type: crmcontracts.ContactMomentEvidenceTypeRelationshipChange, Id: &derived},
...
// cases above vary.
func viewFixture(t *testing.T) crmcontracts.Contact360 {
	t.Helper()
	...
	view := crmcontracts.Contact360{
		Contact: crmcontracts.Contact{FullName: "Anna Weber"},
