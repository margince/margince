...
var dossierCache = readerCache{
	selectOne: `
		SELECT fingerprint, generated_at, generated_by, payload FROM company_dossier
		 WHERE user_id = $1 AND company_id = $2`,
	upsertOne: `
		INSERT INTO company_dossier (user_id, company_id, fingerprint,
...
var growthFitCache = readerCache{
	selectOne: `
		SELECT fingerprint, generated_at, generated_by, payload FROM company_growth_fit
		 WHERE user_id = $1 AND company_id = $2`,
	upsertOne: `
		INSERT INTO company_growth_fit (user_id, company_id, fingerprint,
		                            generated_at, generated_by, payload)
		VALUES ($1, $2, $3, $4, $5, $6)
		ON CONFLICT (user_id, company_id) DO UPDATE
		SET fingerprint = EXCLUDED.fingerprint,
...
func (c readerCache) load(ctx context.Context, pool *pgxpool.Pool,
	...
	err := database.WithWorkspaceTx(ctx, pool, func(tx pgx.Tx) error {
		return tx.QueryRow(ctx, c.selectOne, userID, companyID).
