...
var (
	sectionSummary         = string(crmcontracts.CompanyDossierSectionKindSummary)
	sectionProductsService = string(crmcontracts.CompanyDossierSectionKindProductsServices)
	sectionMarkets         = string(crmcontracts.CompanyDossierSectionKindMarkets)
	sectionBuyingCenter    = string(crmcontracts.CompanyDossierSectionKindBuyingCenter)
	sectionDifferentiation = string(crmcontracts.CompanyDossierSectionKindDifferentiation)
	sectionFirmographics   = string(crmcontracts.CompanyDossierSectionKindFirmographics)
)
...
// nobody made.
var natureFact = string(crmcontracts.CompanyBriefSentenceNatureFact)
...
//
// A field with no row id is SKIPPED rather than cited against the company.
...
// label here for exactly that reason: the company's name is already the
