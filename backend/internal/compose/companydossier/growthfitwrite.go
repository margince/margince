...
var (
	observations = map[string]bool{natureFact: true, string(crmcontracts.CompanyBriefSentenceNatureAssessment): true}
	suggestions  = map[string]bool{string(crmcontracts.CompanyBriefSentenceNatureRecommendation): true}
)
