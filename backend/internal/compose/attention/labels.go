...
func (s *Service) fillSubjectLabels(ctx context.Context, out *crmcontracts.Attention) error {
	...
	for _, optional := range []*[]crmcontracts.AttentionItem{
		out.Commitments, out.AtRisk, out.Meetings, out.RelationshipDecay, out.DidNotRun, out.Dsr, out.SyncHealth, out.CaptureHealth, out.AiWorkHealth, out.Bounces, out.AutomationHealth,
	} {
		if optional != nil {
