...
func TestThePageCountsEachKindOfWork(t *testing.T) {
	...
	got := (&Service{}).worklistFrom(t.Context(), day, scopeAll, "", 25, nil, nil, false)
...
func TestWorkBelowTheCutIsStillCounted(t *testing.T) {
	...
	got := (&Service{}).worklistFrom(t.Context(), day, scopeAll, "", 3, nil, nil, false)
...
func TestANarrowedPageStillCountsTheKindsItIsNotDrawing(t *testing.T) {
	...
	got := (&Service{}).worklistFrom(t.Context(), day, scopeAll, "deals_at_risk", 25, nil, nil, false)
...
func TestAFoldedGroupCountsTheItemsItStandsFor(t *testing.T) {
	...
	got := (&Service{}).worklistFrom(t.Context(), day, scopeAll, "", 50, nil, nil, false)
...
func TestCountsAreOrderedTheSameWayTwice(t *testing.T) {
	...
	first := (&Service{}).worklistFrom(t.Context(), day, scopeAll, "", 25, nil, nil, false)
	second := (&Service{}).worklistFrom(t.Context(), day, scopeAll, "", 25, nil, nil, false)
...
func TestABoundedSourceFilteredToNothingStillSaysThereMayBeMore(t *testing.T) {
	...
	// kept none.
	out := (&Service{}).worklistFrom(t.Context(), day, scopeUnassigned, "", 25, nil, nil, false)
