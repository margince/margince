...
// Package contactcontext holds the readings of a Contact360 that more than one
// prose surface takes.
//
// Three packages fold the same 360 into their own input — the contact draft, the
...
//
// What this package is NOT is a canonical Contact360 fold. The three consumers
...
// CurrentEmployer names where this contact works now, or nothing.
//
