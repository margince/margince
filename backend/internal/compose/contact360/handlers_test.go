...
func TestGetContact360RefusesAnOverlayWorkspace(t *testing.T) {
	h := NewHandlers(nil, overlayModeReturning(true, nil))
	rec := httptest.NewRecorder()
	req := httptest.NewRequest(http.MethodGet, "/v1/contacts/x/360", nil)

	h.GetContact360(rec, req, crmcontracts.Id(ids.NewV7()), crmcontracts.GetContact360Params{})
...
func TestGetContact360RefusesWhenTheModeCannotBeResolved(t *testing.T) {
