...
func rungPast(
	...
	rung func(context.Context, time.Time, *crmcontracts.Contact360) (crmcontracts.ContactMoment, bool),
	dismissed func(crmcontracts.ContactMoment) bool,
) (crmcontracts.ContactMoment, bool) {
...
func withoutMoment(page crmcontracts.Contact360, moment crmcontracts.ContactMoment) crmcontracts.Contact360 {
