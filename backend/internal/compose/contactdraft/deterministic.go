...
// something to say: what this contact SAID outranks the deal it was said about,
...
func dealLine(deal *DealIn) string {
	spoken := contactcontext.SpokenAmount(deal.AmountMinor, deal.Currency)
	if spoken == "" {
		return deal.Name
	}
