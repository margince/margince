...
// The model lane: the prompt, the fence around the contact's own text, and the
...
// draftSystem is the contact_draft site's prompt.
//
...
// signature. And a claim is what this contact said, so it may be answered but
