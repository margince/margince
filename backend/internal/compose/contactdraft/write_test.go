...
func recipientInput() contactdraft.Input {
...
func TestAFencedAnswerIsRead(t *testing.T) {
	...
	draft, err := contactdraft.ParseDraft(raw, recipientInput())
	if err != nil {
...
func TestAnAnswerThatIsNotJSONIsStillRefused(t *testing.T) {
	if _, err := contactdraft.ParseDraft("I could not write this one, sorry.", recipientInput()); err == nil {
