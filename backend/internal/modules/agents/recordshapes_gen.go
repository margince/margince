...
var updateRecordShapes = map[string]string{
	...
	"company":      "{address?: {city?: string, country?: string, line1?: string, line2?: string, postal_code?: string, region?: string}, description?: string, display_name?: string, domains?: [{domain: string, is_primary?: boolean}], industry?: string, legal_name?: string, linkedin_url?: string, owner_id?: uuid, parent_company_id?: uuid, relationship_types?: [\"customer\"|\"partner\"|\"supplier\"|\"investor\"|\"portfolio_company\"|\"competitor\"|\"other\"], size_band?: \"1-10\"|\"11-50\"|\"51-200\"|\"201-500\"|\"501-1000\"|\"1001-5000\"|\"5000+\", status?: \"unknown\"|\"target\"|\"prospect\"|\"opportunity\"|\"customer\"|\"former_customer\"|\"disqualified\", visibility?: \"workspace\"|\"owner\"}",
...
var listRecordFilters = map[string][]listFilter{
	...
	"company": {
		...
		{Name: "status", Type: "string", Enum: []string{"unknown", "target", "prospect", "opportunity", "customer", "former_customer", "disqualified"}},
		{Name: "tag_id", Type: "array"},
		{Name: "tag_mode", Type: "string", Enum: []string{"any", "all", "none"}},
		{Name: "unassigned", Type: "boolean"},
	},
