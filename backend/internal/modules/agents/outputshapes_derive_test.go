...
func TestEveryResultTypeSatisfiesTheSchemaDerivedFromIt(t *testing.T) {
	...
	for name, value := range map[string]any{
		...
		"MergeRecordsResult":   MergeRecordsResult{Merged: true, RecordType: "contact", SurvivorID: id},
		...
		"WhoKnowsAnswer":       WhoKnowsAnswer{ContactID: id, Colleagues: []KnownColleague{{UserID: id, DisplayName: "Ada", StrengthBucket: "moderate"}}},
