...
var searchContextCopy = toolCopy{
	...
	Limits: "Ranked, never exhaustive: records that also match may be absent, and no count of them " +
		...
		"carries no project column.",
	Instead: "Use catch_me_up_on with project_id for one project, query_workspace when the question " +
		"has conditions, a date bound or a related record to reach through, and search_records when " +
		"you have the exact name or phrase.",
