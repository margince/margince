...
// anonymizeContactRecord, deleteIdentifyingSatellites, purgeSubjectPurchases
// and clearCommunicationRecord — the contact/anonymize action's full
// implementation — live in retentionanonymize.go: this file is the dispatch
// table and the authorable set, and that is the second concept, big enough on
// its own to earn the split.
