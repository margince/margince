...
//
// Tables owned: app_user, federated_identity, mfa_challenge_spent,
// mfa_recovery_code, passport, role, role_assignment, session, setup_token,
// team, team_membership, user_mfa, workspace.
