...
// an ACCOUNT by employer name even when the contact never matches, and a
// 'confirmed' row needs a matched_contact_id it would not have. The company-matched,
// contact-unmatched row IS the reach case.
