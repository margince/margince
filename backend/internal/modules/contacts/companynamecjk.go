...
// Company-name matching for Chinese, Japanese and Korean, where a name has no word
...
// different legal contact from the company beside them, so the tables above must
...
// company-name write lock is held. Four is past any real name.
