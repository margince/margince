...
//
// Two writers land these rows — a contact filling the company form, and an
...
// a contact has since claimed. A human write passes `true` because a contact's
// answer always outranks what is there — including their own earlier one.
//
// The values arrive through a SELECT over the company rather than a VALUES
...
// by, and the columns refuse an archived record (companyColumnWrites); evidence
...
const upsertCompanyProfileField = `
