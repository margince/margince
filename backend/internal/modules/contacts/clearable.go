...
// clearableContactColumns maps the wire fields a contact restore may set to NULL
...
func clearableContactColumns(current crmcontracts.Contact) map[string]storekit.Clearable {
