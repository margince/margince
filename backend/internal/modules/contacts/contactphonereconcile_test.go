...
// The defect this guards: a contact legitimately holds one number twice under two
...
func TestReconcileDropOneOfTwoTypesKeepsTheRightRow(t *testing.T) {
	...
	submitted := []ContactPhoneInput{{Phone: "+493011112222", PhoneType: "home", Position: 0}}
...
func TestReconcileTypeChangeKeepsExistingRow(t *testing.T) {
	...
	submitted := []ContactPhoneInput{{Phone: "+49111", PhoneType: "home", Position: 0}}
...
// A number the contact no longer lists is archived; a number they did not hold is
