...
// the SoR provider decode through these same functions), for contact and
...
func TestContactCreateInputCarriesCustomFieldKeys(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("contactCreateInput: %v", err)
	}
...
func TestContactUpdateInputCarriesCustomFieldKeys(t *testing.T) {
