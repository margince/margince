...
// ConfirmAnchorCompanySiteRead atomically binds the inspected draft, creates or
...
func (s *Store) ConfirmAnchorCompanySiteRead(ctx context.Context, in ConfirmCompanySiteReadInput, stagePeople StageSiteReadPeople) (Company, []string, error) {
