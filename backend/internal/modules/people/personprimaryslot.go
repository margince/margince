...
// The per-type primary slot: at most one of a person's contact rows of a given
// type may be primary. uq_person_email_primary and uq_person_phone_primary hold
