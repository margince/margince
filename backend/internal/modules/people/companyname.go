...
// overwrite it, gated by company.name_source (nameSourceDomain marks a
// name still provisional).

import "github.com/margince/margince/backend/internal/platform/freemail"

// The company.name_source provenance values (0120). Ordered weakest to
...
// DisplayNameFromDomain turns a mail domain into a readable company name.
//
