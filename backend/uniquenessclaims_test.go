...
//
// The register is 641 lines with no reasons, and that is deliberate rather than
// sloppy: a reason per entry would be 641 rationalisations written by somebody
